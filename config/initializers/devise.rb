...
Devise.setup do |config|
  ...
  # config.secret_key = '8471e33db8ed47b51683833c4fcb63d75c08b9aa44bcda431c649a8b790f60e166547ecd9d41e35b1d6696d45e21c7a181bd9bc2028fbc3495a36d030fb0f3df'
  ...
  # config.pepper = 'ed8f359aa04afe8339339926e1faca97d342e65a138d3d9398a7f597f70516f86a409c39be88f8fa5baec6d76207b5a8303ee0225431fe7ee40be956de4a0974'
  ...
  #   manager.default_strategies(scope: :user).unshift :some_external_strategy
    ...
    if Rails.application.config.allow_autologin
      puts 'Activating AutoLogin.'
      puts '!!! NEVER ACTIVATE AUTOLOGIN IN PRODUCTION !!!'
      manager.default_strategies(scope: :user).unshift :auto_login
      ::AutoLoginStrategy.authorized_users << User.find_or_create_by(user_name: 'dev_user').user_name
    end
  end
